...
DISEASE_KB = {
    ...
    "직업성간질환": {
        "ref": "별표3 제6호",
        "signals": ["간", "간염", "독성간염", "유기용제", "화학물질", "사염화탄소", "디메틸포름아미드",
                    "DMF", "황달", "납땜", "솔벤트", "유해물질"],
        "criteria": [
            {"id": "solvent_exposure", "text": "간독성 유기용제·화학물질 취급 경력", "need": "작업환경측정·취급물질 MSDS"},
            {"id": "temporal", "text": "노출과 간 손상 발현의 시간적 선후관계", "need": "직력·진단일·간기능검사 추이"},
            {"id": "liver_finding", "text": "간기능검사·영상상 손상 소견", "need": "혈액검사(AST/ALT)·복부영상"},
            {"id": "exclude_other", "text": "음주·바이러스성 간염 등 다른 원인 배제", "need": "기왕력·간염표지자 검사"},
        ],
    },
}
